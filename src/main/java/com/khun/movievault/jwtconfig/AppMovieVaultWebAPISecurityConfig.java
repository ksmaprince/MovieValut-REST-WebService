...
@Configuration
@EnableWebSecurity
public class AppMovieVaultWebAPISecurityConfig {
    @Autowired
    private AppMovieVaultUserDetailService appMovieVaultUserDetailService;
    @Autowired
                ...
                .authorizeHttpRequests(
                        auth -> {
                            auth
                                    ...
                                    .requestMatchers("/movievault/v1/api/file/**").authenticated();
//                                    .requestMatchers("/adsweb/api/v1/get/**").authenticated();
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authenticationProvider.setUserDetailsService(appMovieVaultUserDetailService);
